...
function clear() {
    ...
    for(i=0;i<items.length;i++){
        items[i].quantity=0;//updating value to JSON
    }
...
function checkout(){
    finalcheck="";
    finalcheck = finalcheck + "<tr><th>Name</th><th>Category</th><th>Unit Price</th><th>Quantity</th><th>Total</th></tr>";
    grandtotal="";
    grandtotal=grandtotal+"<tr><th>Grand Total</th><th></th><th></th><th></th><th></th></tr>";
